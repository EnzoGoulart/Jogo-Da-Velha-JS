...
pPreto.addEventListener('click', () => {
  ...
  inDiv2.forEach(cell=>{
    cell.style.color = 'rgb(59, 124, 209)'
  })
  pWhite()
})
...
pVermelho.addEventListener('click', () => {
  ...
  pBlack('white', 'white')
  inDiv2.forEach(cell=>{
    cell.style.color = 'rgb(252, 255, 54)'
  })
  cells.forEach(cell => {
...
pAzul.addEventListener('click', () => {
  ...
  cells.forEach(cell => {
    cell.style.backgroundColor = 'rgb(178, 139, 255)'
  })
})
function pWhite() {
